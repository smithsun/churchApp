...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, daily_digest.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, daily_digest.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, daily_digest.domain.Digests.class.getName() + ".dailyVerses");
            createCache(cm, daily_digest.domain.DailyVerses.class.getName());
