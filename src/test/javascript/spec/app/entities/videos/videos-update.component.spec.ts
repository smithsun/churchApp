...
import VideosUpdateComponent from '@/entities/videos/videos-update.vue';
import VideosClass from '@/entities/videos/videos-update.component';
...
describe('Component Tests', () => {
  describe('Videos Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<VideosClass>(VideosUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.videos = entity;
        videosServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(videosServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.videos = entity;
        videosServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(videosServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        videosServiceStub.retrieve.resolves([foundVideos]);
